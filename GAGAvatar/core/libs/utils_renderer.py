...
def render_gaussian(gs_params, cam_matrix, cam_params=None, sh_degree=0, bg_color=None):
    ...
    # print("cam_params['size']:", cam_params['size'])
    ...
    #bg_color_1 = torch.zeros((batch_size, NUM_CHANNELS, 512, 256), dtype=torch.float32, device="cuda")
    #bg_color_2 = torch.ones((batch_size, NUM_CHANNELS, 512, 256), dtype=torch.float32, device="cuda") * 0.5
    #bg_color = torch.concatenate([bg_color_1, bg_color_2], dim = -1)
    #warnings.warn("bg_color:")
    # print(bg_color.size())
